...
public class VTableVisitor extends GJDepthFirst {
 @Override
   ...
   public Object visit(ClassExtendsDeclaration n, Object argu) {
       ...
       //map child class to parent class
       instance.inherit.put(class_name, parent_cn);

       //insert child class fields name
       List<String> child_fields = new ArrayList<String>(parent_fields);
       ...
       //child_fields.addAll(parent_fields);
       instance.insertFields(class_name, child_fields);


       List<String> parent_methods = instance.getMethods(parent_cn);
       List<String> methods_name = new ArrayList<String>();

       //insert child methods first
       vec = n.f6.nodes;
       it = vec.iterator();
       while(it.hasNext()) {
         MethodDeclaration md = (MethodDeclaration)it.next();
       ...
       //then append parents'
       methods_name.addAll(parent_methods);
       //finally insert the class name and its methods name to hash table
       instance.insertMethods(class_name, methods_name);
       return super.visit(n, argu);
   }
   ...
   public Object visit(MethodDeclaration n, Object argu) {
     ...
     while(it.hasNext()) {
       ...
       //only insert object type that is different from cur_class
       ...
       //////////////////////////////////////////////////
       //insert all the object type to local methods table
       //if(local.f0.f0.choice instanceof Identifier) {
         String name = tn + "." + ln;
         local_vars.add(name);
       //}
       //////////////////////////////////////////////////
     ...
     //////////////////////////////////////////////////
     String key = cur_class + "." + cur_method;
     instance.locals.put(key, local_vars);
     //////////////////////////////////////////////////
   ...
   public Object visit(FormalParameter n, Object argu) {
       ...
       String key = cur_class + "." + cur_method;
       List<String> local_vars = instance.locals.get(key);
       if(local_vars == null)
        local_vars = new ArrayList<>();

       //treated parametes as locals, all insert into locals method table
       //if(n.f0.f0.choice instanceof Identifier) {
         //String name = tn + "." + pn;
         local_vars.add(tn + "." + pn);
         instance.locals.put(key, local_vars);
       //}
