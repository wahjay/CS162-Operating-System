...
public class VaporVisitor extends GJDepthFirst {
  ...
  @Override
    ...
    public Object visit(ArrayAssignmentStatement n, Object argu) {
        ...
        String Lts = unique();
        code += Lts + " = LtS(0 " + index.code + ")\n";
        String Eq = unique();
        code += Eq + " = Eq(0 " + index.code + ")\n";
        code += Eq + " = Add(" + Lts + " " + Eq + ")\n";
        ...
        //code += rhs.result == null? "" : rhs.code;
        //code += "[" + t2 + "]" + " = " + (rhs.result==null? rhs.code : rhs.result) + "\n";
        //System.out.println(code);
        return new Pair(code, null);
    }
    ...
    public Object visit(WhileStatement n, Object argu) {
        ...
        //System.out.println(exp.code + " | " + exp.result);
        code += getWhileTop(t1) + ":\n";
    ...
    public Object visit(PrintStatement n, Object argu) {
        ...
        code += "PrintIntS(";
        code = code + (p.result == null? p.code : p.result) + ")\n";
        return new Pair(code,null);
    ...
    public Object visit(ArrayLookup n, Object argu) {
        ...
        //check if the array is in the class field, if not then
    ...
    public Object visit(ArrayLength n, Object argu) {
        ...
        if (reg == null) {
          MethodTable instance = MethodTable.getInstance();
          String cur_class = instance.cur_class;
          int pos = instance.getFPosition(cur_class, p.code);
          code += t + " = " + "[this+" + pos + "]\n";
        }
    ...
    public Object visit(MessageSend n, Object argu) {
        ...
        if (n.f4.node != null) {
          ...
          //func_arg += (p1.result == null? p1.code : p1.result) + " ";
        ...
        if(pos == -1) {
          ...
          //if Obj_type is still null, probably because it's defined in its super class
          //pos = instance.getMPosition(Obj_type, p3.code);
        }
        ...
        if (p2.code.equals("this")) {
          ...
          func_setup += "if0 " + (p2.result==null? p2.code : p2.result) + " goto :" + getNullLabel(t1);
          ...
          String t = unique();
          //get table
          load_func = "\n" + t + " = " + "[" + (p2.result==null? p2.code : p2.result) + "]\n";
          //get func
          load_func += t + " = " + "[" + t + "+" + pos + "]\n";
          ...
          //func call
          if(n.f4.node == null)
            func_call = t2 + " = " + "call " + t + "(" + (p2.result==null? p2.code : p2.result) + ")\n";
          else
            func_call = t2 + " = " + "call " + t + "(" + (p2.result==null? p2.code : p2.result) + " " + func_arg + ")\n";
    ...
    public Object visit(NotExpression n, Object argu) {
        ...
        String t = unique();
        code += p.result == null? "" : p.code;
        code += t + " = " + "Sub(1 " + (p.result == null? p.code : p.result) + ")\n";
        return new Pair(code, t);
    }
